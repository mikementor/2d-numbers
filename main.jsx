...
class DataGrid{
  ...
  viewToGrid({x,y}){
   return ({x:(this.size-x-1+this.offsetX),y:(this.size-y-1+this.offsetY)});
  }
   render(){
     const subgrid = new GridView(this.grid).calculateWindow([this.offsetX,this.offsetY], this.size, 'top-left');
